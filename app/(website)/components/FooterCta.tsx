...
export default function FooterCta() {
  return <section className="bg-[url('/home/cta-bg.jpg')] bg-cover bg-center text-white max-md:text-center">
    <div className="cg-container py-8 h-[420px] flex items-center">
      <div className="max-w-4xl">
        ...
        <Link href="/contact">
          <Button size="lg" variant="white">Talk to our specialist</Button></Link>
      </div>
    </div>
