...
interface InquiryCustomerConfirmationProps {
  firstName: string;
  lastName: string;
  baseUrl?: string;
  logoUrl?: string;
...
export const InquiryCustomerConfirmation = ({
  firstName,
  lastName,
  baseUrl = "https://ac-expert.vercel.app",
  logoUrl = "https://ac-expert.vercel.app/aircon-experts.svg",
}: InquiryCustomerConfirmationProps) => {
  return (
    <Html>
      <Head />
      <Preview>Thank you for your inquiry to Aircon Experts</Preview>
      <Body style={main}>
...
export default InquiryCustomerConfirmation;
